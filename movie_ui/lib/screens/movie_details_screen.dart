...
import 'package:movie_ui/models/movie_detail.dart';

import '../blocs/movieDetail/movie_detail_bloc.dart';
import '../blocs/movieDetail/movie_detail_event.dart';
import '../blocs/movieDetail/movie_detail_state.dart';
import '../models/cast_list.dart';
import '../models/movie.dart';
import 'package:url_launcher/url_launcher.dart';

import '../models/screen_shot.dart';
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: ListView.separated(
                                      ...
                                      itemCount: movieDetail.movieImage?.backdrops.length ?? 0,
                                  ...
                                  Container(
                                    ...
                                    child: ListView.separated(
                                      ...
                                      itemBuilder: (context, index) {
                                        Cast cast = movieDetail.castList?[index] ?? Cast();
                                        return Container(
                                          child: Column(
                                            children: <Widget>[
                                              Card(
